...
<html>
  <head>
    ...
    <link href="http://192.168.1.207/iflair_test/fbChatSource/public/style/jquery-ui-1.10.4.custom.min.css" rel="stylesheet" type="text/css" />
    <!--    <link href="/style/non-responsive.css" rel="stylesheet" type="text/css" />-->
    <link href="http://192.168.1.207/iflair_test/fbChatSource/public/style/core.css" rel="stylesheet" type="text/css" />
  </head>
  <body>
...
MSG;
    ...
    <script type="text/javascript" src="http://192.168.1.207/iflair_test/fbChatSource/public/scripts/jquery-1.11.0.min.js"></script>
    <script type="text/javascript" src="http://192.168.1.207/iflair_test/fbChatSource/public/scripts/chat.js"></script>
  </body>
</html>
